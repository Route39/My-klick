        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {data.map((c, i) => (
            <motion.div key={c.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: Math.min(i * 0.02, 0.2) }}
              ...
              className="group flex flex-col justify-between cursor-pointer gap-4 rounded-2xl border border-slate-200/70 bg-white p-4 transition hover:border-emerald-500/30 hover:shadow-md">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="rounded-xl bg-emerald-50 px-3 py-2 text-center shrink-0">
              ...
              <div className="mt-auto">
                ...
                <div className="flex gap-2 border-t border-slate-100 pt-3 text-xs text-slate-500">
